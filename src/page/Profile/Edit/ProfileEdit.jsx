    ...
    <div className="min-h-screen bg-grayLight pt-8">
      ...
      <div className="mx-[12rem]">
        <div className="flex h-80">
          <div className="w-[25rem] text-lg font-semibold text-grayDark">Personal Info</div>
          <form className="flex-grow" onSubmit={handleSubmit1}>
            <div className="my-auto rounded-b-lg shadow-lg">
              <div className="grid h-60 grid-cols-2 grid-rows-3 items-center rounded-t-lg bg-white text-sm">
                <div className="mx-auto">
                  <div className="mb-1 font-semibold text-grayDark">이름</div>
                  <input
                    id="name"
                    type="text"
                    className="h-8 w-[20rem] rounded-lg border border-placeHolder pl-3"
                    value={name}
                    onChange={onChange}
                    placeholder="김세론"
                  />
        ...
        <hr className="my-3" />
        <div className="flex">
          <div className="w-[25rem] text-lg font-semibold text-grayDark">Profile</div>
          <form className="flex-grow" onSubmit={handleSubmit2}>
            <div className="rounded-b-lg shadow-lg">
              <div className="flex h-40 rounded-t-lg bg-white">
                ...
                <div className="ml-5 flex-grow py-9">
                  <div className="mb-1 text-sm font-semibold text-grayDark">
                    <li>한줄 소개 작성</li>
                  </div>
                  <textarea
                    id="selfIntroduction"
                    className="rounded-lg border border-placeHolder px-3 py-3 text-xs"
                    cols="60"
                    rows="4"
